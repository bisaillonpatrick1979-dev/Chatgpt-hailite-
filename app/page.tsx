...
const people = [
  ...
  { name: "Mathieu Cote", role: "Employe", initials: "MC", href: "/worker", color: "bg-blue-600", status: "Mes donnees" },
  { name: "Stephane Roy", role: "Sous-traitant", initials: "SR", href: "/contractor", color: "bg-purple-600", status: "Mes invoices" },
  { name: "Alex Tremblay", role: "Employe", initials: "AT", href: "/worker", color: "bg-green-600", status: "Mes chantiers" }
];
  ...
  return (
    <main className="min-h-screen bg-[#070b12] p-4 text-slate-100">
      <section className="mx-auto max-w-6xl pt-6">
        <div className="rounded-[2rem] border border-slate-800 bg-[radial-gradient(circle_at_top_left,#253244,#0b0f17_55%)] p-6 shadow-2xl">
